...
const steps = [
  { num: "01", title: "L'Impasto", desc: "48 horas de fermentación en frío. La paciencia es el primer ingrediente." },
  { num: "02", title: "La Mano", desc: "El pizzaiolo estira la masa a mano. Sin rodillo. Nunca." },
  { num: "03", title: "Il Forno", desc: "450°C de leña. 90 segundos. Ni uno más." },
  { num: "04", title: "La Mesa", desc: "La pizza llega a tu mesa entera, sin cortar. Como en Napoli." },
];
