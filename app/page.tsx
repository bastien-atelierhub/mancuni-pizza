    ...
    <>
      ...
      <main className="w-full bg-background min-h-screen">
        ...
        <section id="hero">
          <PizzaCanvas>
            <div className="flex items-end h-full w-full px-8 md:px-16 lg:px-24 pb-[120px] md:pb-32">
              <div className="flex flex-col items-start max-w-2xl bg-black/60 backdrop-blur-[4px] p-6 md:p-0 md:bg-transparent md:backdrop-blur-0 rounded-sm">
        ...
        <section className="relative w-full md:min-h-screen mt-0 md:mt-40 bg-[#0A0A0A] flex flex-col md:block">
          ...
          <motion.div 
            {...fadeIn}
            className="order-2 md:order-none relative w-full h-[85vh] md:absolute md:inset-0 md:h-full overflow-hidden"
          >
            <img
          ...
          <div className="order-1 md:order-none relative z-10 grid grid-cols-1 md:grid-cols-2 md:min-h-screen items-center">
            ...
            <motion.div 
              {...fadeInUp}
              className="flex flex-col justify-center px-6 md:px-16 lg:px-20 pt-8 pb-32 md:pt-32 md:pb-16 bg-[#0A0A0A] md:bg-transparent"
            >
        ...
        <section id="menu" className="relative bg-background pt-8 pb-[350px] md:pb-36 px-6 md:px-12 lg:px-24 overflow-hidden">
          ...
          <motion.div 
            {...fadeInUp}
            className="relative z-10 text-center mb-16 md:mb-20"
          >
          ...
          <motion.div 
            {...fadeInUp}
            className="relative z-10 grid grid-cols-2 lg:grid-cols-3 gap-1 md:gap-[2px] max-w-6xl mx-auto"
          >
        ...
        <section id="storia" className="bg-background">
          <div 
            className="relative w-full h-[35vh] md:h-[70vh] flex items-center justify-center bg-scroll md:bg-fixed bg-center bg-cover" 
            style={{ 
          ...
          >
            ...
            <motion.h2 
              {...fadeInUp}
              className="relative z-10 font-title text-white text-[26px] leading-tight sm:text-4xl md:text-5xl lg:text-7xl tracking-tight text-center px-4 w-full md:whitespace-nowrap" style={{ textShadow: "0 4px 30px rgba(0,0,0,0.8)" }}
            >
              Nata a Napoli.<br className="md:hidden" /> Viva en Asunción.
            </motion.h2>
          </div>
          <motion.div 
            {...fadeIn}
